...
export default function Experience() {
  ...
  return (
    <section id="experience" className="px-4 sm:px-6 lg:px-12 py-8 sm:py-12 bg-gray-900 text-gray-200">
      ...
      <div className="max-w-4xl mx-auto">
        {experiences.map((exp, idx) => (
          <motion.div
            ...
            className="p-4 sm:p-6 mb-6 bg-gray-800/60 backdrop-blur-lg rounded-xl 
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-gray-500">{exp.year}</p>
            <ul className="list-disc list-inside mt-3 text-gray-300 space-y-1 text-sm sm:text-base">
